                ...
                <div className="flex bg-slate-950 justify-center items-center flex-col text-white">
                    <div className="w-full flex justify-center items-center flex-col bg-slate-950 text-white overflow-hidden">
                        ...
                        <ul className="w-full flex lg:flex-col xl:flex-row sm:flex-col justify-center items-center mt-6">
                            ...
                            <li className="m-2 sm:m-4">
                                <Cards icons={<FiInstagram/>} title="Instagram"
                                       url="https://www.instagram.com/rahmicantut/"/>
                            </li>
                            <li className="m-2 sm:m-4">
                                <Cards icons={<FaSpotify/>} title="Spotify"
                                       url="https://open.spotify.com/user/aolhhguvxt6z7xvaw9ysk34gk?si=29717a5b5f4e48ce"/>
                            </li>
                            <li className="m-2 sm:m-4">
                                <Cards icons={<FaLinkedin/>} title="Linkedin"
                                       url="https://www.linkedin.com/in/rahmican-tut-37a165265/"/>
                            </li>
                        </ul>
                    </div>
                    <hr className="border-slate-600 border-2 w-full mt-8"/>
                    <div
                        className="w-full bg-slate-950 text-white flex justify-center items-center flex-col mt-12 p-6 lg:p-12">
                        ...
                        <ul className="flex justify-center mt-4 space-x-4">
                            ...
                            <li className="text-2xl cursor-pointer hover:opacity-50">
                                <a href="https://www.instagram.com/rahmicantut/" target="_blank"
